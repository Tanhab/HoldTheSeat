 ...
 * configured anywhere.
 *
 * <p>The image matches compose. {@code org.testcontainers.kafka.KafkaContainer} is the
 * driver for apache/kafka; the sibling {@code ConfluentKafkaContainer} expects
 * confluentinc/cp-kafka and the 1.x class of the same name lives in another package.
 */
@SpringBootTest
